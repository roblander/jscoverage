...
#define JSCOVERAGE_INSTRUMENTED_HEADER "/* automatically generated by JSCoverage - do not edit */\n"
#define JSCOVERAGE_INSTRUMENTED_HEADER_LENGTH (sizeof(JSCOVERAGE_INSTRUMENTED_HEADER) - 1)
